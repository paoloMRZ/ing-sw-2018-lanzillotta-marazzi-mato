...
public class InvalidShadeValueException extends InvalidValueException {
    ...
    //OVERVIEW: viene lanciata quando si rileva un valore imossibile per un parametro che rappresenta la sfumatura di un dado.

    public InvalidShadeValueException(){super();}
    public InvalidShadeValueException(String msg){super(msg);}
}
