...
public class AlesatorePerLaminaDiRame extends Utensils {
        ...
        public AlesatorePerLaminaDiRame(){
            super(3,"alesatore-per-la-lamina-di-rame", Color.RED,"Muovi un qualsiasi dado nella tua vetrata ignorando le restrizioni di " +
                    "valore Devi rispettare tutte le altre restrizioni di piazzamento");
        }

    public void accept(Visitor c, ToolCard3 m){
        c.visit(this,m);
    }
